...
const Footer = () => {
  ...
  const indiaDestinations = ["Kashmir", "Kerala", "Ladakh", "Goa", "Rajasthan", "Himachal Pradesh", "Hyderabad", "Andaman"];
  const internationalDestinations = ["Dubai", "Singapore", "Thailand", "Bali", "Europe", "Switzerland", "Turkey", "Australia"];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-3">
              <div>
                ...
                <ul className="space-y-2">
                  {indiaDestinations.slice(0, 4).map(dest => <li key={dest}>
                      <Link to={`/destinations/${dest.toLowerCase().replace(/\s+/g, "-")}`} className="text-background/70 hover:text-primary transition-colors text-sm">
                        {dest}
                      </Link>
                    </li>)}
                </ul>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {internationalDestinations.slice(0, 4).map(dest => <li key={dest}>
                      <Link to={`/destinations/${dest.toLowerCase().replace(/\s+/g, "-")}`} className="text-background/70 hover:text-primary transition-colors text-sm">
                        {dest}
                      </Link>
                    </li>)}
          ...
          delay: 0.3
            ...
            <ul className="space-y-4">
              ...
              <li>
              <a href="mailto:info@alisonholidays.com" className="flex items-center gap-3 text-background/70 hover:text-primary transition-colors">
