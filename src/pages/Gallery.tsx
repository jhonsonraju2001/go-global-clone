...
const galleryImages: GalleryImage[] = [
  ...
  { id: 23, src: "https://images.unsplash.com/photo-1587474260584-136574528ed5?w=800&h=600&fit=crop", title: "Ladakh Mountains", category: "Destinations", location: "Ladakh, India" },
  { id: 24, src: "https://images.unsplash.com/photo-1590123575668-53235cfe28ef?w=800&h=600&fit=crop", title: "Goa Beaches", category: "Destinations", location: "Goa, India" },
  { id: 25, src: "https://images.unsplash.com/photo-1565967511849-76a60a516170?w=800&h=600&fit=crop", title: "Singapore Skyline", category: "Destinations", location: "Singapore" },
  { id: 26, src: "https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?w=800&h=600&fit=crop", title: "Thailand Temples", category: "Destinations", location: "Thailand" },
  { id: 27, src: "https://images.unsplash.com/photo-1527838832700-5059252407fa?w=800&h=600&fit=crop", title: "Himachal Valley", category: "Destinations", location: "Himachal Pradesh" },
  { id: 28, src: "https://images.unsplash.com/photo-1573790387438-4da905039392?w=800&h=600&fit=crop", title: "Andaman Waters", category: "Destinations", location: "Andaman Islands" },
  // Events
  ...
  { id: 29, src: "https://images.unsplash.com/photo-1527631746610-bca00a040d60?w=800&h=600&fit=crop", title: "Desert Safari Group", category: "Group Tours", location: "Rajasthan, India" },
  { id: 30, src: "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=800&h=600&fit=crop", title: "Camping Adventure", category: "Group Tours", location: "Uttarakhand, India" },
  // Experiences
  ...
  { id: 31, src: "https://images.unsplash.com/photo-1506929562872-bb421503ef21?w=800&h=600&fit=crop", title: "Sunrise Houseboat", category: "Experiences", location: "Kerala, India" },
  { id: 32, src: "https://images.unsplash.com/photo-1518002171953-a080ee817e1f?w=800&h=600&fit=crop", title: "Northern Lights", category: "Experiences", location: "Europe" },
  // Vehicles
