...
const blogPosts = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1575089976121-8ed7b2a54265?w=800&h=600&fit=crop",
    author: "Food Expert",
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {blogPosts.map((post, index) => (
                <motion.article
                  ...
                  whileHover={{ y: -5 }}
                  className="bg-background rounded-xl overflow-hidden shadow-lg border hover:shadow-xl transition-all duration-300 group"
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Button variant="ghost" size="sm" className="gap-1 text-primary group-hover:translate-x-1 transition-transform">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                <input
                  ...
                  className="flex-1 px-4 py-3 rounded-lg border focus:outline-none focus:ring-2 focus:ring-primary transition-shadow"
                />
                <Button size="lg" className="hover:scale-105 transition-transform">Subscribe</Button>
              </div>
            </motion.div>
          </div>
        </section>
