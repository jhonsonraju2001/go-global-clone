...
const About = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
        {/* Hero */}
        <section className="relative h-[400px] bg-cover bg-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1488085061387-422e29b40080?w=1920')" }}>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-muted-foreground mb-4">
                  Go Global Vacations was founded with a simple mission: to make travel accessible, enjoyable, and memorable for everyone. What started as a small travel desk has grown into one of Hyderabad's most trusted travel agencies.
                </p>
                <p className="text-muted-foreground mb-4">
